...
const AboutUs = () => {
  return (
    <div style={{backgroundColor:'black'}}>
        ...
        <video style={{position:'absolute' , left:'0.1px', top:'50px'  , width:'100%'  }} loop autoPlay  height="cover"  >
    ...
    >
      ...
      <Typography style={{marginTop:"150px"}} color="inherit" align="center" variant="h2" marked="center">
        About us
      </Typography>
      <Typography
        color="inherit"
...
<div >
    <Grid style={{display:'flex', justifyContent:'space-around'}} container spacing={4}>
        <motion.Grid whileHover={{scale:1.02 }} style={{position:'relative' , top:'0px' , marginBottom:'30px'}}  >
            <CardMo />
        </motion.Grid>
        <motion.Grid whileHover={{scale:1.02 }} style={{position:'relative' , top:'0px'}} >
            <CardOd  />
        </motion.Grid>
        <motion.Grid whileHover={{scale:1.02}} style={{position:'relative' , top:'0px'}} >
            <CardSa/>
